...
const firstDayMaxTempElement = document.getElementById(
  "firstDayMax-temperature"
);
const firstDayMinTempElement = document.getElementById(
  "firstDayMin-temperature"
);
...
const secondDayMaxTempElement = document.getElementById(
  "secondDayMax-temperature"
);
const secondDayMinTempElement = document.getElementById(
  "secondDayMin-temperature"
);
...
const thirdDayMaxTempElement = document.getElementById(
  "thirdDayMax-temperature"
);
const thirdDayMinTempElement = document.getElementById(
  "thirdDayMin-temperature"
);
...
const forthDayMaxTempElement = document.getElementById(
  "forthDayMax-temperature"
);
const forthDayMinTempElement = document.getElementById(
  "forthDayMin-temperature"
);
...
const fifthDayMaxTempElement = document.getElementById(
  "fifthDayMax-temperature"
);
const fifthDayMinTempElement = document.getElementById(
